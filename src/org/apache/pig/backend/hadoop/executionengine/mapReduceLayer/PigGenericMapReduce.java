...
public class PigGenericMapReduce {
    ...
    public static class Map extends PigMapBase {
        ...
        public void cleanup(Context oc)
        	...
        	Integer isH2IRG = Integer.parseInt(jConf.get("rollup.h2irg.foreach"));
        	...
        	if(isH2IRG == 1) {
        		...
        		Integer reducerNo = Integer.parseInt(jConf.get("mapred.reduce.tasks"));
        		Integer length = Integer.parseInt(jConf.get("rollup.h2irg.dimension_size"));
