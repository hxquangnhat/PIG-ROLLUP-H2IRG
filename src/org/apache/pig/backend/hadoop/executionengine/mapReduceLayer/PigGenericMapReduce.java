...
public class PigGenericMapReduce {
    ...
    public static class Map extends PigMapBase {
        ...
        public void cleanup(Context oc)
            ...
            boolean isHII = jConf.getBoolean(PigConfiguration.PIG_HII_ROLLUP_OPTIMIZABLE, false);
            ...
            if(isHII) {
                ...
                int length = jConf.getInt(PigConfiguration.PIG_HII_NUMBER_TOTAL_FIELD, 0);
                int nAlgebraic = jConf.getInt(PigConfiguration.PIG_HII_NUMBER_ALGEBRAIC, 1);
